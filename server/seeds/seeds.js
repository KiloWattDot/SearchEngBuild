...
db.once('open', () => {
    ...
    // })
    User.create({"username": "dorothedj", "email": "jack@gmail.com", "password": "pasword1234", "savedBooks": [{"authors": ["Jackie"], "description": "Book about modeling", "bookId": "modelbook", "title": "Jackie's Modleing book"}]})
    .then(() => {
        console.log('Book inserted')
    })
})
